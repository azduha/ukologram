...
rules.gdocs = function (tokens, idx, options /*, env */) {
  var src = ' src="' + escapeHtml(tokens[idx].src) + '"';
  var link = tokens[idx].alt ? ('<a class="gDocsOpen" target="_blank" href="' + tokens[idx].alt + '" >Otevřít v Google Docs <i class="fa fa-caret-right"></i></a>') : '';
  return '<iframe class="gDocs"' + src + '></iframe>' + link;
};
